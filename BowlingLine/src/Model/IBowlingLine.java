...
public interface IBowlingLine {
  ...
  */
  public abstract int scoreSoFar();
   ...
   */
  public abstract void pinsDowned(int pins);
   ...
   */
  public abstract boolean canShowScoreFrame(int frame);

  /**
   * Returns the results of the given frame as a string showing both rolls (if
   * applicable). Usually this is three characters long and replaces the first
   * 10 with "X" for a strike and any combination of two rolls adding to ten
   * with "/" in the second place to represent a spare.
   * 
   * Examples:
   ...
   *  "54 " - Only get two rolls in the 10th if there is no strike and no spare      
